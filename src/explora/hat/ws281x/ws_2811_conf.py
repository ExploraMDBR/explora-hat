...
# lib_path = os.path.join(dir_path, "lib/rpi_ws281x/python/build/lib.linux-armv7l-2.7")
...
# parser.add_argument('--dump', '-D', nargs='?', default=False, help= "Just print the incoming message on stdout (no leds)")
# parser.add_argument('--debug', '-d', nargs='?', default=False, help= "Print the incoming message on stdout ")
...
LED_FREQ_HZ    = 500000     # Frequency of the LED signal.  Should be 800khz or 400khz.
